            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $ang['nohp'] }}</td>
                        <td>
                            <form action="{{ route('anggota.destroy',$ang['nama']) }}" method="POST">
                            <a href="{{ route('anggota.show',$ang['nama']) }}" class="badge badge-primary">Detail</a>
                            <a href="{{ route('anggota.edit',$ang['nama']) }}" class="badge badge-primary">Edit</a>
